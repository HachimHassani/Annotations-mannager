...
useEffect(() => {
  fetch("http://localhost:8080/admin/texts",header)
...
function handleCandidate(event,id){
  ...
  axios.post('http://localhost:8080/admin/texts/'+id,{title:text.title,content:text.content
              ...
              >
                <Box sx={style}>
                  <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    <div>
                      <h3 className="text-lg leading-6 font-medium text-gray-900">Add text</h3>
                      <p className="mt-1 max-w-2xl text-sm text-gray-500">Add text to be annotated.</p>
                    </div>
              ...
              <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                ...
                <div className="ml-4 mt-2 flex-shrink-0" style={{ marginLeft: 1068 }}
                  >
                    ...
                    <button
                      onClick={(e) =>DeleteHandler(e,text.id)}
                      style={{ marginLeft: 8 }}
